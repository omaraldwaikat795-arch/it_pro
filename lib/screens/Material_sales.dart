...
class MaterialSales extends StatefulWidget {
  const MaterialSales({super.key});

  @override
  State<MaterialSales> createState() => _MaterialSalesState();
}

class _MaterialSalesState extends State<MaterialSales> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(" Material sales", style: TextStyle(color: Colors.white)),
