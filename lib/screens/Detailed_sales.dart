...
class DetailedSales extends StatefulWidget {
  const DetailedSales({super.key});

  @override
  State<DetailedSales> createState() => _DetailedSalesState();
}

class _DetailedSalesState extends State<DetailedSales> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Detailed sales", style: TextStyle(color: Colors.white)),
